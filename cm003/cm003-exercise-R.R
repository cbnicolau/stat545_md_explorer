...
#This doesnt work becasuse you cant start with a number or an underscore

preamble <- "My commute time, in minutes:" 

## What data types do `my_commute` and `preamble` contain? Use `typeof`.
typeof(my_commute) # this is a double, a number with decimals
typeof(preamble) # this is a character

## Let's use the `paste` function to print out the preamble followed by
##  the commute time:
paste(preamble, my_commute)

## Bring up the documentation for the `print` function. opens up the documentation in the bottom right corner
?paste
...
commute <- c(my_commute, 5, 35, 15, 60)
commute
