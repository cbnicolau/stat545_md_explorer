...
These are examples where R is not doing what we want because we are dealing with vectors.
when encontering problems like this check if the database has factors in them
