...
5. Put the x-axis on a log scale, first by transforming the y variable. 
...
```{r}
a + geom_point(alpha=0.1) #aplpha is transparency here 1 is opaque
```
